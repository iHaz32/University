...
void initializeA(double **A, int n) {
    ...
    A[0][1] = 1, A[0][8] = 1, A[1][2] = 1, A[1][4] = 1, A[1][6] = 1, A[2][1] = 1, A[2][5] = 1, A[2][7] = 1, A[3][2] = 1, A[3][10] = 1, A[4][0] = 1, A[5][9] = 1, A[6][9] = 1, A[7][3] = 1, A[7][9] = 1, A[8][4] = 1, A[8][5] = 1, A[9][13] = 1, A[10][6] = 1, A[10][7] = 1, A[10][9] = 1, A[11][8] = 1, A[11][12] = 1, A[12][13] = 1, A[12][11] = 1, A[12][9] = 1, A[13][12] = 1, A[13][10] = 1;
