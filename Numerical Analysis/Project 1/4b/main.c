...
void initializeA(double **A, int n) {
    ...
    A[0][1] = 1, A[0][8] = 1, A[1][2] = 1, A[1][4] = 1, A[1][6] = 1, A[2][1] = 1, A[2][5] = 1, A[2][7] = 1, A[3][2] = 1, A[3][11] = 1, A[4][0] = 1, A[4][9] = 1, A[5][9] = 1, A[5][10] = 1, A[6][9] = 1, A[6][10] = 1, A[7][3] = 1, A[7][10] = 1, A[8][4] = 1, A[8][5] = 1, A[8][9] = 1, A[9][12] = 1, A[10][14] = 1, A[11][6] = 1, A[11][7] = 1, A[11][10] = 1, A[12][8] = 1, A[12][13] = 1, A[13][14] = 1, A[13][12] = 1, A[13][10] = 1, A[13][9] = 1, A[14][13] = 1, A[14][11] = 1;
...
void powerMethod(double **G, double *eigenVector, int n) {
    ...
    copyVector(G[0], old, n); // Initalize G[0] vector as the beginning eigenvector approximation
